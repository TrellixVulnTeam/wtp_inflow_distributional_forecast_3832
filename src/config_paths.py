...
name_model_gamlss_best_fit_oracles = 'l_-6_tpred_15_text_15_train_5_tinter_3_furain_True_rfore_False_cumr_6_intunknown=True_shrunken_fmse=10_niters=20000_warm=True_lbda=0_test.json'
name_model_gamlss_best_fit_rfore = 'l_-6_tpred_15_text_15_train_5_tinter_3_furain_True_rfore_True_cumr_6_intunknown=True_interrainrain_True_shrunken_fmse=10_niters=20000_warm=True_lbda=0_train.json'
name_model_gamlss_no_thresholds_oracles = 'l_-6_tpred_1_text_1_train_1_tinter_0_furain_True_rfore_False_cumr_None_intunknown=True_interrainrain_False_shrunken_fmse=10_niters=20000_warm=True_lbda=0_test.json'
name_model_gamlss_3_thresholds_oracles = 'l_-6_tpred_3_text_3_train_3_tinter_0_furain_True_rfore_False_cumr_None_intunknown=True_interrainrain_False_shrunken_fmse=10_niters=20000_warm=True_lbda=0_test.json'
name_model_gamlss_only_wtp_oracles = 'l_-6_tpred_1_text_0_train_0_tinter_0_furain_False_rfore_False_cumr_None_intunknown=True_interrainrain_False_shrunken_fmse=10_niters=20000_warm=True_lbda=0_test.json'
name_model_gamlss_lstm_oracles = 'l_-6_furain_True_rfore_False_mse_10.0_units_10_dopout_0.0001_test.json'
name_model_gamlss_sarx_oracles = 'sarx_l_-6_tpred_1_text_1_train_1_tinter_0_furain_True_rfore_False_cumr_None_intunknown=True_test.json'
name_model_gamlss_lstm_rfore = 'l_-6_furain_True_rfore_True_mse_10.0_units_10_dopout_0.0001_test.json'
name_model_gamlss_sarx_rfore = 'sarx_l_-6_tpred_1_text_1_train_1_tinter_0_furain_True_rfore_True_cumr_None_intunknown=True_test.json'
